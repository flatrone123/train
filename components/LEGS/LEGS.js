    ...
    render() {
        let exercise1 = `
          <div class="podhod__exercise">
            <div class="podhod__exercise__title">Подъем на одну ногу *20</div>
        ...
        let exercise2 = `
          <div class="podhod__exercise">
            <div class="podhod__exercise__title">Присед *20</div>
        ...
        let exercise3 = `
          <div class="podhod__exercise">
            <div class="podhod__exercise__title">Выпад *20</div>
            <button class="podhod__exercise__breik" onclick="timer(this, 60)">1 мин</button>
          </div>
          `;
        ...
        let exercise4 = `
          <div class="podhod__exercise">
            <div class="podhod__exercise__title">На носки *20</div>
            <button class="podhod__exercise__breik" onclick="timer(this, 60)">1 мин</button>
          </div>
          `;
